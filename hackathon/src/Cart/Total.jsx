...
const Total = () => {
  ...
  const loadList = async () => {
    await fetch(
      `http://communitybuyingbackend.pythonanywhere.com/main/place-order/`,
      {
        method: "get",
        headers: {
          Authorization: `Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjQwMzIyNzk4LCJpYXQiOjE2NDAwNjM1OTgsImp0aSI6IjJkNDk2Y2YzYzU1YzRjMTNiMmJjYmZjNzc2Mjk1NTI1IiwidXNlcl9pZCI6MjF9.uo1UEecB89sZ-ocvS4PUwdnLb2_7aBq3qVHlqhqkCEo`,
        },
      }
    )
      .then((result) => {
  ...
  return (
    <div>
      <h2
        style={{ alignItems: "center", marginBottom: "5vh", marginLeft: "5vh" }}
      >
        SUMARRY OF YOUR SHOPPING
      </h2>
      <Button
        onClick={() => placeorder()}
        variant="contained"
      ...
      {load?.map((index, key) => (
        ...
        >
          <div>
            <CardMedia padding="2vh" height="150" width="50">
              <img
                src={notplaced}
                alt="cart"
                style={{ objectFit: "contain", padding: "3vh" }}
              />
            </CardMedia>
          </div>
              ...
              <div className="cont-left">
                <div className="cont-block1">
                  <div className="head-3">
                    ...
                    >
                      <AddShoppingCartIcon
                        onClick={() => editStock(index.item, index.qty)}
                      />
                    </Typography>
                  </div>
                </div>
